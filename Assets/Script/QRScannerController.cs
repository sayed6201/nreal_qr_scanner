...
[HelpURL("https://developer.nreal.ai/develop/unity/rgb-camera")]
    public class QRScannerController : MonoBehaviour
    {
        ...
        public void Scan()
        {
            try
            {
                ...
                if (result != null)
                {
                    ...
                    textOut.fontSize = 30;
                    if (myData.ContainsKey(result.Text)) openLinkButton.SetActive(true);
                    else openLinkButton.SetActive(false);
        ...
        public void viewInformation()
        {
            ...
            textOut.text = APIHelper.DEFAULT_DISPLAY_TEXT;
            infoText.text =  APIHelper.getCompanyInfo(myQrCode);
            openLinkButton.SetActive(false);
